...
<figure>
	<img src="docs/images/guiacliente.jpg" align="middle" width="3000"/>
...
<figure>
	<img src="docs/images/servidortest.jpg" align="middle" width="3000"/>
	<img src="docs/images/servidortest1.jpg" align="middle" width="3000"/>
	<figcaption>Fig. 2 - Servidor, guía del sistema de comunicación.</figcaption>
</figure>

En este punto, se comprueba la dirección IPv4 del equipo (ejecutando en la consola del sistema "ipconfig" si es Windows o "ifconfig" si es Linux/Mac) y se copia en el apartado "Ip\_address" del Servidor y se mueve Test a su campo llamado "Server User".
...
<figure>
	<img src="docs/images/communicationresults.jpg" align="middle" width="3000"/>
